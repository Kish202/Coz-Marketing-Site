...
function Navbar({theme, setTheme}) {
  ...
  return (
    <header className="relative  border-b-[1px] border-primary/50 bg-gradient-to-t from-violet-900 via-violet-600 to-violet-900 text-white dark:bg-gradient-to-t dark:from-violet-900 dark:via-violet-950 dark:to-violet-900 shadow-lg font">
