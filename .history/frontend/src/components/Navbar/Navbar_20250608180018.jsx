...
function Navbar({theme, setTheme}) {
  ...
  return (
   ...
   <div>
                    <h1 className="pb-1 mt-3    border border-yellow-950  text-xl m-1 font-semibold"> The Best Selling</h1>
                <p className="text-sm m-1 ">
                    ...
                    <div className="grid grid-cols-3 col-span-2  gap-12 border border-yellow-600">
