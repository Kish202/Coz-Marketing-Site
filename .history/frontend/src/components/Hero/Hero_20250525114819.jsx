...
const Hero = () => {
  return (
    <main className="bg-gradient-to-r from-violet-950 to-violet-900 pt-2 dark:bg-violet-950 relative overflow-hidden">
      {/* Tilted Ellipse Background */}
      <div className="absolute left-6 top-1/2 -translate-y-1/2 w-80 h-48 bg-gradient-radial from-sky-400/30 via-sky-300/20 to-transparent rounded-full transform -rotate-12 blur-xl z-50"></div>
      
      <section className="container flex h-[650px] flex-col items-center justify-center md:h-[500px] relative z-10">
        <div className="grid grid-cols-1 items-center gap-8 dark:text-white md:grid-cols-2">
          <div
            data-aos="fade-right"
