...
const Hero = () => {
  return (
    <main className="bg-gradient-to-r from-violet-950 to-violet-900 pt-2 dark:bg-violet-950 relative overflow-hidden">
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-80 h-48 bg-gradient-radial from-sky-400/30 via-sky-300/20 to-transparent rounded-full transform -rotate-12 blur-xl z-"></div>
