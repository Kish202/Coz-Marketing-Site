...
const Service =() =>{
  return (
    <section className="container h-12 md:h-32">
     <div className="grid grid-cols-4 w-full   border border-yellow-900 bg-teal-300 p-2 shadow-lg dark:bg-violet-800 dark:text-white/70 md:max-w-[800px] md:-translate-y-16 md:p-8">
