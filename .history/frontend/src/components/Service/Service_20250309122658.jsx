...
const Service =() =>{
  return (
    <section className="container h-12 md:h-32 border border-lime-900">
     <div className="grid grid-cols-4 w-full place-items-center  border border-yellow-900 bg-lime-100 p-2 shadow-lg dark:bg-violet-800 dark:text-white/70 md:max-w-[800px] px-0 md:p-8">
...
Clients
  ...
  <CountUp end={57} suffix="+" duratiion={2.75}/>  </h1>  
    ...
    <div className="flex flex-col items-center justify-center" >
        ...
        <h1 className="text-sm text-black/80 dark:text-white  sm:text-lg md:text-3xl font-bold">
