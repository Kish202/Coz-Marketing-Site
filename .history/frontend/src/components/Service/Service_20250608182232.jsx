...
const Service =() =>{
  return (
    <section className="container h-12 md:h-32 ">
     <div className="grid grid-cols-4 w-full mx-auto -translate-y-12 divde-x divide-slate-700 place-self-center   bg-lime-100 p-4  dark:bg-violet-800 dark:text-white/70 md:max-w-[800px] rounded-xl shadow-inner  shadow-md:p-8">
